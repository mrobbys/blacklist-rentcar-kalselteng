...
const CardItem = memo(({ item }) => {
  return (
    <div className="border-border-light bg-neutral-white hover:border-brand-primary rounded-xl border p-5 shadow-sm transition-all duration-200">
      {/* Header Card Start */}
      ...
      <div className="border-border-light bg-neutral-light-white mb-3 flex items-center gap-2 rounded-lg border p-2.5">
        ...
        <code className="text-neutral-light-black font-mono text-xs font-bold tracking-wider">{item.NO || '-'}</code>
      </div>
